...
<head>
    ...
    <title>DataMyAutoz | OUR PACKAGES.</title>
...
<div id="precheck" class="pt-4">
    <div class="container-fluid">
        <h1 class="mb-2 mb-lg-4 text-center">
            <span class="blc">Great!</span> Your order has been completed, and the credits has been added to your account. <br>
        ...
        <div class="advantage mt-4 mb-lg-2 d-none d-lg-block">
            <div class="row">
                ...
                <div class="col adv text-center">
                    ...
                    <div class="mx-auto txt">DATAMYAUTOZ is an Approved NMVTIS Data Provider - which contains Information from every state
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
                    ...
                    <div class="mx-auto txt">DATAMYAUTOZ provides users with trusted vehicle history
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
