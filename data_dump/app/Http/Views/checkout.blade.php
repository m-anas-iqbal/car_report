        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="report_summary">
                    @if($error_code == '0' || $error_code == '4,14')
                    ...
                    <div class="summary_status_signup">
                        ...
                        <div class="package_chooser">
                            ...
                            <ul>
                                <li>
                                    <label for="package1">
                                        <input type="radio" value="package1" name="package" id="package1" data-price="35" required @if($selected_package=='package1' ) checked @endif>
                                        <span> 1 Report <strong>$35</strong> </span>
                                    </label>
                                </li>
                                <li>
                                    <label for="package2">
                                        <input type="radio" value="package2" name="package" id="package2" data-price="30" required @if($selected_package=='package2' ) checked @endif>
                                        <span> 2 Reports <strong>$60</strong> </span>
                                    </label>
                                </li>
                                <li>
                                    <label for="package3">
                                        <input type="radio" value="package3" name="package" id="package3" data-price="59" required @if($selected_package=='package3' ) checked @endif>
                                        <span> 5 Reports <strong>$99</strong> </span>
                                    </label>
                                </li>
                                <li>
                                    <label for="package4">
                                        <input type="radio" value="package4" name="package" id="package4" data-price="98" required @if($selected_package=='package4' ) checked @endif>
                                        <span> 10 Reports <strong>$154</strong> </span>
                                    </label>
                                </li>
                                <li>
                                    <label for="package5">
                                        <input type="radio" value="package5" name="package" id="package5" data-price="150" required @if($selected_package=='package5' ) checked @endif>
                                        <span> 25 Reports <strong>$200</strong> </span>
                                    </label>
                                </li>
                                <li>
                                    <label for="package6">
                        ...
                        <div class="payment_method_selector">
                            ...
                            @if($setting->paypal == 1 && $setting->stripe == 1)
...
<script>
  $(document).ready(function(){
	...
	/*
    //var stripe = Stripe('pk_live_51Lb3pCCQ5WZ0K12EfExTgnojCd89UGkdzGBDGQz9WUAvsrnNPhnoMJfgJQWVLmsaIOMkE6sYTzHlLyQ62irVoLyE00yrZO6StT');
    var stripe = Stripe('pk_live_51Lb3pCCQ5WZ0K12EfExTgnojCd89UGkdzGBDGQz9WUAvsrnNPhnoMJfgJQWVLmsaIOMkE6sYTzHlLyQ62irVoLyE00yrZO6StT');
