...
<html>
  <head>
    ...
    <title>VIN Report Generated</title>
  </head>
    <body>
                    ...
                    <tr>
                      <th class="small-12 large-12 columns first last">
                        <table>
                          <tr>
                            <th>
                              <h1 class="text-center">GETVEHREPORT</h1>
                              <h4 class="text-center">Congratulations! Your account has been created</h4> 
                            </th>
                          ...
                          <tr>
                            <th>
                             ...
                             <center data-parsed="">
                                  ...
                                  <tr>
                                    <td>
                                      <table>
                                        <tr>
                                          <td>
                                            <a href="{{route('index')}}/{{$report->report_url}}">Download Report Now</a>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
                              ...
                              <p>GETVEHREPORT is an Approved NMVTIS (National Motor Vehicle Title Information System) Data Provider. NMVTIS is a national database designed to protect consumers from fraud and unsafe vehicles, keep stolen vehicles from being resold, and provides users with accurate and complete vehicle information.</p>
                              <center data-parsed="">
