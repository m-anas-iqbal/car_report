...
<head>
    ...
    <title>MYAUTOSHISTORY | OUR PACKAGES.</title>
...
<div id="precheck" class="pt-4">
    <div class="container-fluid">
        <h1 class="mb-2 mb-lg-4 text-center">
            <span class="blc">Great!</span> Here is your complete vehicle history report for <br>
            <span class="blc h-vin">#{{$report->vin}}</span> 
        </h1>
        <div class="row">
            <div class="col-xl-12 text-center d-flex-colum">
                <div class=" fw-600 text-center mt-2">You can download the report by clicking button below.</div>
