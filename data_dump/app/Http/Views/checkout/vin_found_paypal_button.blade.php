...
<head>
    ...
    <title>OURINFOGET | OUR PACKAGES.</title>
    ...
    <div class="container-fluid">
        ...
        <div class="advantage mt-4 mb-lg-2 d-none d-lg-block">
            <div class="row">
                ...
                <div class="col adv text-center">
                    ...
                    <div class="mx-auto txt">OURINFOGET is an Approved NMVTIS Data Provider - which contains Information from every state
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
                    ...
                    <div class="mx-auto txt">OURINFOGET provides users with trusted vehicle history
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
                        ...
                        <div class=" " id="packages_div">
                            <div class="packets row d-flex flex-nowrap">
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between active" data-id="package1" data-price="39">
                                        <p>1 report</p> 
                                            <span class="packet-price">$39</span>
                                            <div class="ext-old ext-old-c mt-auto"></div>
                                            <div class="ext-am" style="display: none;">$39</div>  
                                    </div>
                                </div>
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between " data-id="package2"  data-price="60">
                                        <p>2 Reports</p> 
                                ...
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between" data-id="package3"  data-price="120">
                                        <p>5 Reports</p> 
                            ...
                            <div class="packets row d-flex flex-nowrap"> 
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between" data-id="package4"  data-price="22">
                                        <p>10 Reports</p> 
                                ...
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between" data-id="package5"  data-price="450">
                                        <p>25 Reports</p> 
                                ...
                                <div class="col px-2 mb-3 packet-item">
                                    <div class="pack pack-pr h-100 text-center  d-flex flex-column justify-content-between" data-id="package6"  data-price="750">
                                        <p>50 reports</p> 
                ...
                <div id="card-block">
				  ...
				  <div class="mb-3">
					<div class="form-check">					 
						...
						<label>
							 I am agreed with <a href="{{route('terms')}}">Terms of service</a> & <a href="">Refund Policy</a>.
						</label>
					...
					<p><span style="color: red;">Note:</span> After completion of payment, please wait for redirect back to our website to get your report automatically.</p>
				  </div>
            </form>
        </div>
        <div class="d-flex total mt-auto flex-column">
            <div class="d-flex">
                ...
                <span class="ms-auto" id="tot-val">$39</span>
            </div>
        </div>
    </div>
    <div  id="pay-btn">
