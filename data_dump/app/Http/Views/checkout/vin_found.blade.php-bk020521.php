...
<head>
    ...
    <title>AUTOREPORTSLIVE | OUR PACKAGES.</title>
...
<div id="precheck" class="pt-4">
    <div class="container-fluid">
        <h1 class="mb-2 mb-lg-4">
            <span class="blc">Great!</span> Here is your free vehicle history report for {!!$vehicle!!}
            <span class="blc h-vin">#{{$data['vin']}}</span> 
        </h1>
        <div class="row report_prev">
                ...
                <div class="row specs-row">
                    ...
                    <div class="col-6 mb-2">
                        <div class="media media-check">
                            ...
                            <div class="media-body">
                                Country
                                <h5 class="mt-0">{{$data['plant_country']}}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mb-2">
                    ...
                    <div class="col-6 mb-2">
                        <div class="media media-check">
                            ...
                            <div class="media-body">
                                Manufacturer
                                <h5 class="mt-0">{{$data['manufacturer']}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 text-center s-col relative order-0 order-lg-1" style="position: relative;">
                        ...
                        <div class="s-body">
                            <div class="row top-row">
                                <div class="col-lg text-center text-lg-start order-0 order-lg-1">
                                    <span class="rep_logo_pre"><img src="/images/logo.png" class="logo mb-3" alt="">AUTOREPORTS<i>LIVE</i></span>
                                    <div class="title fw-900 mb-1 mb-lg-2">Vehicle History Report</div>
                                    <h3 class="mb-0">{!!$vehicle!!}</h3>
                                    <p class="fw-800 blc">VIN {{$data['vin']}}</p>
                                </div>
                            </div>
                ...
                <a href="#pay-block" class="btn btn-outline-primary btn-r btn-spl show-blink sc-md" target="_blank" id="sample-btn">View Full Report</a>
            </div>
        </div>
        ...
        <div class="advantage mt-4 mb-lg-2 d-none d-lg-block">
            <div class="row">
                ...
                <div class="col adv text-center">
                    ...
                    <div class="mx-auto txt">AUTOREPORTSLIVE is an Approved NMVTIS Data Provider - which contains Information from every state
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
                    ...
                    <div class="mx-auto txt">AUTOREPORTSLIVE provides users with trusted vehicle history
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
            ...
            <div class="pay-hold h-100 d-flex flex-column">
                ...
                <div id="card-block">
                    <form method="POST" id="payment-form">
                        ...
                        @endguest
                        <div class="cardDiv">
                         <div class="" style="border: 2px solid #ccc;margin: 25px 0 15px;padding-left: 10px; height: 44px;">
                            <div id="card-element">
