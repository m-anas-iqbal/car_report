                ...
                <div id="pay-block" class="mt-3 mt-lg-5 pay-cc">
                    <div class="pay-hold h-100 d-flex flex-column">
                                ...
                                <form method="POST" id="payment-form" action="javascript:;">
                                    ...
                                    <div class="d-flex total mt-auto flex-column">
                                        <div class="d-flex">
                                            ...
                                            <span class="ms-5" id="tot-val">$25</span>
                                        </div>
                                        <button class="paytabs_hosted-pay btn pay-btn btn-r position-relative w-100 d-none" id="paytabs_hostedPay">
                        ...
                        <div id="pay-btn">
                            ...
                            <button type="button" class="cr-pay btn pay-btn btn-r position-relative w-100 mb3 d-none" id="crPay">
