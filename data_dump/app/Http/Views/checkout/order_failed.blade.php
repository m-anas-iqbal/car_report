...
<head>
    ...
    <title>VINSUPERINFO | ORDER FAILED.</title>
...
<div id="precheck" class="pt-4">
    <div class="container-fluid">
        <h1 class="mb-0 mb-lg-0 text-center">
            <span class="blc">Sorry!</span> The payment for your Order # {{$receipt->order_id}} has been failed. <br>
            <span class="blc h-vin">{{$receipt->currency_code}} {{$receipt->amount}} </span> 
        </h1>
        <div class="row">
            <div class="col-xl-12 text-center d-flex-colum"> 
                <div class="rdc fw-600 text-center mt-0">Note: Please contact support</div> 
					<hr>
