...
<div id="precheck" class="pt-4">
    <div class="container-fluid">
        <h1 class="mb-0 mb-lg-0 text-center mt-5">
            <span class="blc">Congratulations!</span> Your payment for your vin report order has been completed. <br>
            <!--<span class="blc h-vin">BTC   </span> -->
        </h1>
        <div class="row">
            <div class="col-xl-12 text-center d-flex-colum">
                ...
                <div class="rdc fw-600 text-center mt-0">Note: Please send the transaction screen shot on complaint@kpointtech.com after confirmations. You report will be emailed to you and extra credits (if ordered) will be added into your account.</div>
				</div>
