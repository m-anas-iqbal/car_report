					...
					<form method="post">
					    @csrf
						 ...
						 <div class="form-group">
						 	...
						 	<textarea class="form-control" placeholder="Enter Bank Information" name="bank_info" id="protextarea"></textarea>
						 </div>
						 <div class="form-group">
						 	<label for="">Waiting Time (Mints)</label>
						 	<input type="number" class="form-control" name="waiting_time" id="wallet_time" required>
						 </div>
						 <div class="form-group">
						 ...
						 <div class="form-group">
						 	<button class="btn btn-primary float-right" id="generateReport">
								<span><i class="fa fa-plus"></i> Add Bank</span>
							</button>
						 </div>
					</form>
					</div>
