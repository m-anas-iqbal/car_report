...
<head>
    ...
    <title>VINENTERINFO | OUR PACKAGES.</title>
        ...
        <div class="advantage mt-4 mb-lg-2 d-none d-lg-block">
            <div class="row">
                ...
                <div class="col adv text-center">
                    ...
                    <div class="mx-auto txt">VINENTERINFO is an Approved NMVTIS Data Provider - which contains Information from every state
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
                    ...
                    <div class="mx-auto txt">VINENTERINFO provides users with trusted vehicle history
                    </div>
                </div>
                <div class="col adv text-center">
                    <span class="mb-2">
